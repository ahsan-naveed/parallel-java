...
public final class ReciprocalArraySum {
        ...
        protected void compute() {
            if (this.endIndexExclusive - this.startIndexInclusive <= SEQUENTIAL_THRESHOLD) {
                ...
                ReciprocalArraySumTask right = new ReciprocalArraySumTask(
                        (this.startIndexInclusive + this.endIndexExclusive) / 2, this.endIndexExclusive, this.input);
                left.fork(); // async
                right.compute();
                left.join();
    ...
    protected static double parArraySum(final double[] input) {
        ...
        ReciprocalArraySumTask.SEQUENTIAL_THRESHOLD = 2000;
    ...
    protected static double parManyTaskArraySum(final double[] input, final int numTasks) {
        ...
        ReciprocalArraySumTask.SEQUENTIAL_THRESHOLD = 200000;
